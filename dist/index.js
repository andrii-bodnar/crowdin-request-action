...
const requester_1 = __nccwpck_require__(4007);
dotenv.config();
function run() {
...
function makeRequest(credentialsConfig) {
    return __awaiter(this, void 0, void 0, function* () {
        const requester = new requester_1.Requester(credentialsConfig, getRetryConfig());
        ...
        const parameters = getPathParameterInputs();
        ...
        yield requester.request(method, request, parameters);
        setOutputs(requester);
    });
}
function getPathParameterInputs() {
...
function getRetryConfig() {
    ...
    return {
        ...
        waitInterval: waitInterval !== null && waitInterval !== void 0 ? waitInterval : 1000,
        skipErrorCodes: skipErrorCodes
            ? skipErrorCodes.split(',').map((code) => {
                return +code.trim();
            })
            : [],
...
const add_query_parameters_1 = __nccwpck_require__(433);
const normalize_url_1 = __importDefault(__nccwpck_require__(6514));
const replace_path_parameters_1 = __nccwpck_require__(2958);
const util = __importStar(__nccwpck_require__(3837));
const fs = __importStar(__nccwpck_require__(7147));
const retry_1 = __nccwpck_require__(4137);
class Requester {
    constructor(credentials, retryConfig) {
        this.credentialsConfig = credentials;
        this.crowdinClient = new crowdin_api_client_1.default(credentials);
        if (!retryConfig) {
            retryConfig = {
                waitInterval: 0,
                retries: 0,
    ...
    request(method, request, pathParams) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.body) {
                if (isStorageAdding) {
                    ...
                    if (((_a = this.headers) === null || _a === void 0 ? void 0 : _a.length) === 0) {
            ...
            try {
                ...
                switch (method.toUpperCase()) {
                    case 'GET':
                        response = yield this.get(requestUrl, requestConfig);
                        break;
                    case 'POST':
                        response = yield this.post(requestUrl, this.body, requestConfig);
                        break;
                    case 'PUT':
                        response = yield this.put(requestUrl, this.body, requestConfig);
                        break;
                    case 'PATCH':
                        response = yield this.patch(requestUrl, this.body, requestConfig);
                        break;
                    case 'DELETE':
                        response = yield this.delete(requestUrl, requestConfig);
                        break;
                    default:
                ...
                if (core.isDebug() && ((_b = e.response) === null || _b === void 0 ? void 0 : _b.data)) {
                    core.error(util.inspect(e.response.data, false, 16));
                }
                if (e instanceof axios_1.AxiosError) {
                    this.responseStatusCode = e.status;
    ...
    getRequestUrl(request, params) {
        let url = `${this.crowdinClient.languagesApi.url}/${(0, replace_path_parameters_1.replacePathParameters)(request, params)}`;
        if (this.query) {
            url = (0, add_query_parameters_1.addQueryParameters)(url, this.query);
        }
        return (0, normalize_url_1.default)(url);
    }
    getRequestConfig(contentType) {
        var _a;
        let headers = new Map();
        (_a = this.headers) === null || _a === void 0 ? void 0 : _a.map(header => {
        ...
        return {
            headers: Object.assign({ 'Content-Type': contentType, 'User-Agent': `crowdin-request-action/0.0.2 axios/${axios_1.default.VERSION}`, Authorization: `Bearer ${this.credentialsConfig.token}` }, Object.fromEntries(headers))
        };
    }
    get(url, config) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.retryService.executeAsyncFunc(() => axios_1.default.get(url, config));
        });
    }
    post(url, data, config) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.retryService.executeAsyncFunc(() => axios_1.default.post(url, data, config));
        });
    }
    put(url, data, config) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.retryService.executeAsyncFunc(() => axios_1.default.put(url, data, config));
        });
    }
    ...
    delete(url, config) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.retryService.executeAsyncFunc(() => axios_1.default.delete(url, config));
        });
    }
    debugObject(data) {
...
const core = __importStar(__nccwpck_require__(2186));
const wait_1 = __nccwpck_require__(7016);
/**
 * @internal
 */
class RetryService {
            ...
            while (true) {
                ...
                try {
                    ...
                    if (this.shouldRetryOnSuccessResponse(response)) {
                        ...
                        yield (0, wait_1.wait)(this.config.waitInterval);
                        continue;
                    }
                    return response;
                }
    ...
    shouldRetryOnSuccessResponse(response) {
    ...
    shouldRetryOnErrorResponse(error, retry) {
        let skip = false;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.addQueryParameters = void 0;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.extractUrlVariableNames = void 0;
...
exports.extractUrlVariableNames = extractUrlVariableNames;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.replacePathParameters = void 0;
const extract_url_variable_names_1 = __nccwpck_require__(7636);
function replacePathParameters(route, params) {
    const variables = (0, extract_url_variable_names_1.extractUrlVariableNames)(route);
    let result = route;
    ...
    variables.map((variable) => {
        ...
        result = result.replace(`{${variable}}`, placeholderValue);
    });
    return result;
}
